...
public class TestAMRMRPCNodeUpdates {
  ...
  public void testAMRMUnusableNodes() throws Exception {
    ...
    MockNM nm1 = rm.registerNode("127.0.0.1:1234", 20000);
    MockNM nm2 = rm.registerNode("127.0.0.2:1234", 20000);
    MockNM nm3 = rm.registerNode("127.0.0.3:1234", 20000);
    MockNM nm4 = rm.registerNode("127.0.0.4:1234", 20000);
    dispatcher.await();
