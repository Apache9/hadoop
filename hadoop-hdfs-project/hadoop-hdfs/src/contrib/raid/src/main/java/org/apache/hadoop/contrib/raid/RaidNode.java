...
/**
 * The RaidNode controls the whole process of HDFS raid and runs as a
 * standalone daemon.
 */
public class RaidNode {
  ...
  public RaidNode(Configuration conf) throws IOException {
    ...
    BlockingQueue<Runnable> taskQueue = new ArrayBlockingQueue<Runnable>(
        TASK_QUEUE_CAPACITY);
    ExecutorService executorService = new ThreadPoolExecutor(CORE_POOL_SIZE,
        MAX_POOL_SIZE, THREAD_KEEP_ALIVE_SECS, TimeUnit.SECONDS, taskQueue,
  ...
  public void start() throws IOException {
    ...
    CollectRaidInfoTask task = new CollectRaidInfoTask(this, conf);
    submitTask(task);
