...
public static final int     DFS_CLIENT_FAILED_DATANODE_MAX_RETRY_DEFAULT = 100;
  ...
  public static final String  DFS_DATANODE_TRANSFER_USE_BLOCKBALANCETHROTTLER_KEY = "dfs.datanode.transfer.use.blockbalancethrottler";
  public static final boolean DFS_DATANODE_TRANSFER_USE_BLOCKBALANCETHROTTLER_DEFAULT = false;
  ...
  public static final String  DFS_NAMENODE_ACLS_MAX_ENTRIES_KEY = "dfs.namenode.acls.max.entries";
  public static final int     DFS_NAMENODE_ACLS_MAX_ENTRIES_DEFAULT = 32;
  ...
  public static final String  DFS_NAMENODE_LOAD_FSIMAGE = "dfs.namenode.load.fsimage";
