...
public static final int     DFS_CLIENT_FAILED_DATANODE_MAX_RETRY_DEFAULT = 100;
  ...
  public static final String  DFS_CLIENT_CREATE_FILE_RECURSIVE = "dfs.client.create.file.recursive";
  public static final boolean DFS_CLIENT_CREATE_FILE_RECURSIVE_DEFAULT = true;
  ...
  // Lease releasing associated keys.
