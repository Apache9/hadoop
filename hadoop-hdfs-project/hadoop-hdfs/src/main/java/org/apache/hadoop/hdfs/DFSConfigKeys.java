...
public static final String  DFS_CLIENT_FAILED_DATANODE_TIMEOUT = "dfs.client.failed.datanode.timeout";
public static final int     DFS_CLIENT_FAILED_DATANODE_TIMEOUT_DEFAULT = 30;
public static final String  DFS_CLIENT_FAILED_DATANODE_MAX_RETRY = "dfs.client.failed.datanode.max.retry";
public static final int     DFS_CLIENT_FAILED_DATANODE_MAX_RETRY_DEFAULT = 100;
  ...
  public static final String  DFS_DATANODE_SLOW_BLOCK_READ_MILLIS_KEY = "dfs.datanode.slow.block.read.threshold.millis";
  public static final int     DFS_DATANODE_SLOW_BLOCK_READ_MILLIS_DEFAULT = 500;
  ...
  public static final String  DFS_BALANCER_MAX_BLOCK_SIZE_TO_FETCH_KEY = "dfs.balancer.maxBlockSizeToFetch";
  public static final long    DFS_BALANCER_MAX_BLOCK_SIZE_TO_FETCH_DEFAULT = 256*1024*1024L;
  ...
  public static final String  DFS_DATANODE_DU_RESERVED_PERCENT_KEY = "dfs.datanode.du.reserved.percent";
  public static final double    DFS_DATANODE_DU_RESERVED_PERCENT_DEFAULT = -1;
  ...
  public static final String  DFS_DATANODE_SCAN_THROTTLE_MAX_MB_KEY = "dfs.datanode.scan.throttle.max.mb";
  public static final int     DFS_DATANODE_SCAN_THROTTLE_MAX_MB_DEFAULT = 8;
  public static final String  DFS_DATANODE_SCAN_THROTTLE_MIN_MB_KEY = "dfs.datanode.scan.throttle.min.mb";
  public static final int     DFS_DATANODE_SCAN_THROTTLE_MIN_MB_DEFAULT = 1;
