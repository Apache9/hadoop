...
public class TestDataStream {
  ...
  public static void setup() throws IOException {
    ...
    conf.setInt(DFSConfigKeys.DFS_CLIENT_SLOW_IO_WARNING_THRESHOLD_KEY, 10000);
    conf.setInt(DFSConfigKeys.DFS_CLIENT_SOCKET_TIMEOUT_KEY, 60000);
  ...
  public void testDfsClient() throws IOException, InterruptedException {
    LogCapturer logs = GenericTestUtils.LogCapturer
        .captureLogs(LogFactory.getLog(DFSClient.class));
