...
public class TestDecommissionBeforeCloseFile {
  ...
  static final int NAMENODE_REPLICATION_INTERVAL = 5; // replication interval
  ...
  public void testDecommissionBeforeCloseFile() throws IOException {
    ...
    LocatedBlocks locs = fileSys.getClient().getLocatedBlocks("/test0", 0);
    ...
    try {
      ...
      // Threee replicas migth still be in decommissioning, the file cannot be closed then.
    }
