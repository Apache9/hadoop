 ...
 *
 */
public class AbstractTestHttp2Client {
  ...
  protected Http2StreamChannel connect() throws InterruptedException,
      ExecutionException {
          ...
          new DefaultHttp2Headers()
              ...
              .authority(
                new ByteString("127.0.0.1:"
                    ...
                    StandardCharsets.UTF_8))).endStream(false).connect().sync()
        .get();
  }
}
