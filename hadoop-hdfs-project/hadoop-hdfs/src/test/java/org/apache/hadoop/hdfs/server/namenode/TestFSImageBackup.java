...
public class TestFSImageBackup {
  ...
  public void testFSImageBackupBasic() throws Exception {
    ...
    try {
      ...
      String imageFileName = cluster.getNameNode(1).getNamesystem().getFSImageBackup().getLastBackupFSImageFileName();
      String mdfilename = cluster.getNameNode(1).getNamesystem().getFSImageBackup().getLastBackupFSImageMD5FileName();
