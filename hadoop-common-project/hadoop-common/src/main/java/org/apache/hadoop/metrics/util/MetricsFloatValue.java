...
/**
 * The MetricsFloatValue class is for a metric that is not time varied
...
public class MetricsFloatValue extends MetricsBase{  
  private float value;
   ...
   */
  public MetricsFloatValue(final String nam, final MetricsRegistry registry, final String description) {
   ...
   */
  public MetricsFloatValue(final String nam, MetricsRegistry registry) {
